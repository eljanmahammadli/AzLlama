...
def main():
    ...
    if args.max_len_prefilter is not None:
        dataset = dataset.filter(
            lambda x: len(x["text"]) < args.max_len_prefilter,
...
python main_filtering.py \
    ...
    --path_kenlm_model /Users/eljan/Documents/azGPT/output_model.klm \
    --num_proc 4 \
    --path_dir_save_dataset /Users/eljan/Documents/azGPT/data/temp \
